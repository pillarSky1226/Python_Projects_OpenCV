...
MODEL_FILE = SCRIPT_DIR / "model" / "binary_128_0.50_ver3.pb"
LABEL_FILE = SCRIPT_DIR / "model" / "binary_128_0.50_labels_ver2.txt"
DEFAULT_VIDEO = SCRIPT_DIR / "src" / "football.mp4"
...
if __name__ == "__main__":
    ...
    if not MODEL_FILE.is_file() or not LABEL_FILE.is_file():
        print("Missing model files. Run: .\\get_models.ps1")
        sys.exit(1)
    if not DEFAULT_VIDEO.is_file():
        print(f"Missing demo video: {DEFAULT_VIDEO}")
        print("Download from: https://drive.google.com/open?id=1jd8WVKHYXfisMO390easOdPkZahonRNd")
        sys.exit(1)
